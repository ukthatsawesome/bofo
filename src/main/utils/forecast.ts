...
export class ForecastEngine {
    ...
    public generateForecast(months: number | null = null): ForecastResult {
        ...
        let currentCash = this._calculateHistoricalCash(initialCash, historyStart, today, oneTimeMap, recurringList);
        ...
        return {
            ...
            insights: this._generateInsights(timeline.filter(t => t.isFuture), netSavings, runway)
        };
    }
    ...
    private _applyInflation(tx: Transaction, isFuture: boolean, enabled: boolean, factor: number): number {
    ...
    private _generateInsights(futureTimeline: TimelinePoint[], netSavings: number, runway: number): ForecastInsight[] {
