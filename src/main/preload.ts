...
contextBridge.exposeInMainWorld('api', {
    ...
    getTransactionsPaginated: (options: any) => ipcRenderer.invoke('get-transactions-paginated', options),
    ...
    setBudget: (category: string, amount: number, period: string, startDate: string, endDate: string) =>
        ipcRenderer.invoke('set-budget', { category, amount, period, startDate, endDate }),
    updateBudget: (id: number, category: string, amount: number, period: string, startDate: string, endDate: string) =>
    ...
    updateRecurringCharge: (id: number, data: any) => ipcRenderer.invoke('update-recurring-charge', { id, data }),
    ...
    chatSandbox: (text: string, context: any) => ipcRenderer.invoke('chat-sandbox', { text, context }),
    ...
    getBillReadingsPaginated: (options: any) => ipcRenderer.invoke('get-bill-readings-paginated', options),
    addBillReading: (data: any) => ipcRenderer.invoke('add-bill-reading', data),
    updateBillReading: (id: number, data: any) => ipcRenderer.invoke('update-bill-reading', { id, data }),
