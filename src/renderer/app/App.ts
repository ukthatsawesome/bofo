...
const VIEW_LOADERS: Record<string, () => Promise<ViewConstructor>> = {
  ...
  forecast: () => import('../features/dashboard/ForecastView').then(m => m.ForecastView),
  budget: () => import('../features/budget/BudgetView').then(m => m.BudgetView),
  goals: () => import('../features/goals/GoalsView').then(m => m.GoalsView),
  whatif: () => import('../features/sandbox/SandboxView').then(m => m.SandboxView),
  recurring: () => import('../features/bills/RecurringChargesView').then(m => m.RecurringChargesView),
  bills: () => import('../features/bills/BillsView').then(m => m.BillsView),
