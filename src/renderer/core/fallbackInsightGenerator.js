...
export class FallbackInsightGenerator {
     ...
     */
    generateTransactionInsight(summary, monthName, isPastMonth) {
        const insights = [];
     ...
     */
    generateBudgetInsight(budgetData) {
     ...
     */
    generateGoalsInsight(goalsData) {
...
// Factory function
export function createFallbackGenerator(formatter) {
