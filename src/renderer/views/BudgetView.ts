...
export class BudgetView extends BaseView {
    ...
    async render(): Promise<void> {
        ...
        tbody.innerHTML = sorted.map(budget => {
            ...
            const freq: Record<string, string> = { weekly: 'Weekly', monthly: 'Monthly', yearly: 'Yearly' };
    ...
    showBudgetModal(category: string = '', amount: string = '', period: string = 'monthly', start: string = '', end: string = ''): void {
