...
export class AISettingsView extends BaseView {
  ...
  async loadAISettings(): Promise<void> {
    ...
    ($('#set-ai-prompt-tx') as HTMLTextAreaElement).value =
      aiSettings.promptTx || defaults.promptTx || '';
    ($('#set-ai-prompt-insight') as HTMLTextAreaElement).value =
      aiSettings.promptInsight || defaults.promptInsight || '';
    ($('#set-ai-prompt-chat') as HTMLTextAreaElement).value =
      aiSettings.promptChat || defaults.promptChat || '';
