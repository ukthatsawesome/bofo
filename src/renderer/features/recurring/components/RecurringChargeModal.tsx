      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Input
            ...
            onInput={(e) =>
              setFormData({ ...formData, amount: parseFloat((e.target as HTMLInputElement).value) })
            }
            step="0.01"
            min="0"
            required
        ...
        <div className="grid grid-cols-2 gap-4">
          <UiSelect
            ...
            onChange={(e) =>
              setFormData({ ...formData, frequency: (e.target as HTMLSelectElement).value as any })
            }
          />
          <Input
            label="Due Day"
            ...
            onInput={(e) =>
              setFormData({ ...formData, due_day: parseInt((e.target as HTMLInputElement).value) })
            }
            min="1"
            max="31"
          />
