...
export const RecurringPage = () => {
  ...
  const HeaderActions = (
    <UiButton variant="primary" icon={<Plus size={18} />} onClick={() => openModal()}>
      Add Charge
    </UiButton>
  );
      ...
      <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                ...
                <p className="text-text-muted text-sm">
                  {charges.filter((c) => c.is_active).length} Active Subscriptions
                </p>
              </div>
                  ...
                  charges.map((charge) => (
                    ...
                    >
                      <td className="px-6 py-4">
                        ...
                        {charge.notes && (
                          <div className="text-[10px] text-text-muted normal-case mt-0.5">
                            {charge.notes}
                          </div>
                        )}
                      </td>
        ...
        <div className="flex items-start gap-3 p-4 bg-brand-primary/5 rounded-xl border border-brand-primary/10">
          ...
          <div className="text-xs text-text-muted leading-relaxed">
            Recurring charges are used by the <strong>Forecast</strong> system to project your
            future timeline. Adding Netflix, Rent, and Subscriptions here allows for accurate cash
            flow predictions.
          </div>
        </div>
