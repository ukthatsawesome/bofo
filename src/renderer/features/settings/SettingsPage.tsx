  ...
  const tabs = [
    {
      ...
      description: 'Manage connected bank accounts and wallets',
    },
    {
      id: 'categories',
      label: 'Categories',
      ...
      description: 'Customize your spending categories',
    },
    {
      id: 'forecast',
      label: 'Forecast',
      icon: TrendingUp,
      component: SettingsForecast,
      description: 'Configure forecasting parameters',
    },
    {
      id: 'preferences',
      label: 'Preferences',
    ...
    },
    {
      ...
      label: 'Bill Types',
      icon: Receipt,
      component: SettingsBillTypes,
      description: 'Manage recurring bill types',
    },
    {
      id: 'ai',
      label: 'AI Assistant',
      ...
      description: 'Configure local AI engine',
    },
    {
      id: 'backup',
      label: 'Backup & Data',
    ...
    },
    {
      ...
      description: 'Configure remote server access',
    },
    {
      id: 'audit',
      label: 'Activity Log',
