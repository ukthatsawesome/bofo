    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <Caption className="mt-1">Access your dashboard from other devices on your local network</Caption>
            </div>
            ...
            <UiCard title="Server Configuration" icon={<Wifi size={20} />}>
                <div className="max-w-xl space-y-6">
                    ...
                    <div className="p-4 bg-info/10 border border-info/20 rounded-lg flex gap-3">
                        <div className="text-info shrink-0"><Wifi size={20} /></div>
                        <div>
                            <h4 className="font-bold text-info text-sm">Beta Feature</h4>
                            <p className="text-xs text-text-muted mt-1">This starts a local web server on your computer. Ensure your firewall allows incoming connections on the specified port.</p>
                        </div>
                    </div>
                    ...
                    <div className={clsx("grid grid-cols-2 gap-4 transition-opacity", !enabled && "opacity-50 pointer-events-none")}>
                        <Input
                            label="Port"
                            value={port}
