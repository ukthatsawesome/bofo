  ...
  return (
    <div className="space-y-6 animate-fade-in pb-20">
      <div className="flex justify-end sticky top-0 bg-surface-base/95 backdrop-blur z-10 py-2 border-b border-border/50 -mx-6 px-6 -mt-6 mb-6">
        <UiButton icon={<Save size={18} />} onClick={handleSave} isLoading={isSaving}>
          Save Changes
        </UiButton>
      </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-surface-base rounded-xl border border-border/50">
                <div>
                  ...
                  <p className="text-xs text-text-muted">
                    Use AI for transaction parsing and financial insights
                  </p>
                </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-[10px] text-text-muted px-1">
                  Make sure you have pulled the model first (e.g. `ollama pull gemma2:2b` or
                  `deepseek-r1:1.5b` )
                </p>
              </div>
            </div>
          ...
          <UiCard title="Advanced Prompting">
            <div className="space-y-4">
              <p className="text-xs text-text-muted mb-4">
                Customize how the AI interprets your data
              </p>
              <div className="space-y-2">
                <label className="text-xs font-bold text-text-muted uppercase tracking-wider ml-1">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onInput={(e) =>
                    handleChange('promptInsight', (e.target as HTMLTextAreaElement).value)
                  }
                  placeholder="Leave empty to use system default..."
                />
              </div>
            ...
            <div className="flex flex-col items-center text-center p-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-text-muted mt-2">
                  When enabled, Bofo can automatically categorize transactions from natural language
                  and provide tailored financial advice based on your spending habits.
                </p>
              </div>
            </div>
          </UiCard>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <div
                  className={clsx(
                    'w-2 h-2 rounded-full',
                    settings.model ? 'bg-success' : 'bg-surface-active'
                  )}
                />
              </div>
            </div>
