    ...
    },
    {
      ...
      accessor: (t) => {
        const mapType = (type: string) => {
          ...
          if (type === 'expense') return 'neutral';
      ...
      accessor: (t) => (
        <div className="flex gap-2 justify-end">
          <button
            ...
            className="text-text-muted hover:text-brand-primary text-xs font-medium transition-colors"
          >
            Edit
          </button>
          <button
            ...
            className="text-text-muted hover:text-danger text-xs font-medium transition-colors"
          >
            Delete
          </button>
        </div>
            ...
            <DataTable
              ...
              onSort={(column) => {
                if (sortField === column) {
                  ...
                  setSortField(column as keyof Transaction);
                  setSortOrder('asc');
                }
              }}
            />
