...
import {
    LineChart, Calendar, TrendingUp, TrendingDown, PiggyBank, Clock, Info,
...
const FORECAST_INFO_TEXT = "Projections are calculated by analyzing your recurring transactions, bills, and average spending patterns over the last 12 months. The \"Runway\" indicates how long your current balances will last at your average burn rate.";
        ...
        >
            <div className="space-y-6">
                ...
                {range === 'custom' && viewMode === 'chart' && (
                    <UiCard className={clsx("bg-surface-base/50 border-dashed transition-colors duration-300", isInvalidRange && "border-danger/30 bg-danger/5")}>
                        <div className="flex flex-wrap gap-4 items-end">
                            <Input
                                ...
                                error={isInvalidRange ? ' ' : undefined} // Just trigger red border
                            />
                            <Input
                                label="End Date"
                                type="date"
