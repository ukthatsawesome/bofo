...
// Centralized configuration for insight styling and icons
            ...
            <UiCard className="border-l-4 border-l-success bg-success/5">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-text-muted">No forecast alerts for this period. You're on track!</p>
                    </div>
                </div>
            </UiCard>
        );
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex-1">
                                <h4 className="font-bold text-sm text-text-primary mb-0.5">
                                    {insight.title}
                                </h4>
                                <p
