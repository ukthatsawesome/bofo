        ...
        <div className="p-2">
          ...
          <div className="grid grid-cols-7 gap-2">
            {Array.from({ length: 35 }).map((_, i) => (
              <div
                key={i}
                className="min-h-[100px] bg-surface-base border border-border rounded-xl"
              ></div>
            ))}
          </div>
        </div>
            ...
            <div
              ...
              className={clsx(
                ...
                !day.isCurrentMonth
                  ...
                  : 'bg-surface-base border-border hover:border-brand-primary/50 cursor-default',
                ...
                <>
                  <div className="flex justify-between items-start mb-1">
                    <span
                      className={clsx(
                        'text-sm font-bold',
                        day.isToday ? 'text-brand-primary' : 'text-text-primary'
                      )}
                    >
                      {day.dayOfMonth}
                    </span>
                  ...
                  <div
                    className={clsx(
                      ...
                      day.projectedBalance < 0 ? 'text-danger' : 'text-text-muted'
                    )}
                  >
