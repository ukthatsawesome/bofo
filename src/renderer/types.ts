...
import type {
    Account, Category, Transaction, Budget, Goal, RecurringCharge,
...
export interface API {
    ...
    getTransactionsPaginated: (options: any) => Promise<{ data: TransactionWithCategory[], total: number, limit: number, offset: number, hasMore: boolean }>;
    ...
    setBudget: (category: string, amount: number, period: string, startDate: string, endDate: string) => Promise<any>;
    updateBudget: (id: number, category: string, amount: number, period: string, startDate: string, endDate: string) => Promise<any>;
