...
const NavItem = ({
  ...
  icon: any;
  label: string;
  statusDot?: 'online' | 'offline' | 'checking' | 'disabled';
}) => {
  ...
  return (
    <nav className="w-64 bg-surface-panel/90 backdrop-blur-xl border-r border-border/50 flex flex-col h-full z-20 transition-all duration-300">
      ...
      <div className="p-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-display font-bold text-xl text-text-primary tracking-tight leading-none">
            Bofo
          </h1>
          <p className="text-[10px] uppercase tracking-wider text-text-muted font-semibold mt-0.5">
            Premium Finance
          </p>
        </div>
      </div>
