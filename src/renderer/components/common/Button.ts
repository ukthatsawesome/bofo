...
export const Button = ({
    ...
    const baseClasses = 'inline-flex items-center gap-2.5 font-bold cursor-pointer transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]';
    ...
    const finalClasses = variant === 'text'
