...
export class NotificationManager {
     ...
     */
    toast(title: string, message: string = '', type: ModalType = 'success', duration: number = 3500): void {
     ...
     */
    async _showModal(title: string, message: string, type: ModalType, isConfirm: boolean): Promise<any> {
