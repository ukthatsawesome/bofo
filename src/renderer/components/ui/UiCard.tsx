...
export const UiCard = ({
    ...
    const variants = {
        ...
        elevated: 'bg-surface-elevated shadow-lg shadow-black/5 dark:shadow-black/20 border-transparent',
    ...
    return (
        ...
        >
            {(title || subtitle || actions || Icon) && (
                <div className={`flex items-start justify-between mb-4 ${noPadding ? 'p-6 border-b border-border' : ''}`}>
