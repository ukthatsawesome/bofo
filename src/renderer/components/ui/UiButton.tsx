...
export const UiButton = ({
  ...
  const variants = {
    ...
    outline:
      'bg-transparent text-text-secondary border border-border hover:bg-surface-base hover:text-text-primary',
    ...
    gradient:
      'bg-gradient-to-r from-brand-primary to-brand-secondary text-white shadow-md hover:shadow-lg hover:scale-[1.02] border-none',
  };
