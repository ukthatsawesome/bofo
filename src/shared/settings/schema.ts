...
export const SettingsSchema = z.object({
  ...
  [SETTING_KEYS.FORECAST.HORIZON]: z
    .string()
    .regex(/^\d+$/)
    .default(String(DEFAULTS.FORECAST.HORIZON)),
  ...
  [SETTING_KEYS.FORECAST.INFLATION_RATE]: z
    .string()
    .regex(/^\d+(\.\d+)?$/)
    .default(String(DEFAULTS.FORECAST.INFLATION_RATE)),
  ...
  [SETTING_KEYS.CURRENCY.SYMBOL_PLACEMENT]: z
    .enum(['before', 'after'])
    .default(DEFAULTS.CURRENCY.SYMBOL_PLACEMENT),
  ...
  [SETTING_KEYS.APPEARANCE.THEME]: z
  ...
  [SETTING_KEYS.SAFETY.BACKUP_ON_CLOSE]: z
    .enum(['true', 'false'])
    .default(DEFAULTS.SAFETY.BACKUP_ON_CLOSE),
  [SETTING_KEYS.SAFETY.AUTO_BACKUP_ENABLED]: z
    .enum(['true', 'false'])
    .default(DEFAULTS.SAFETY.AUTO_BACKUP),
